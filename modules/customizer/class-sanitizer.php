 ...
 */
if(! class_exists( 'Business_Power_Customizer_Sanitizer' ) ){
	class Business_Power_Customizer_Sanitizer{
    	...
    	*/
    	public static function get_sanitize_callback( $type, $instance ){
    		...
    		return apply_filters( 'business_power_customizer_sanitizer', $fn, $type );
    	}
	}
}