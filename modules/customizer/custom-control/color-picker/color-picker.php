...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Business_Power_Customizer_Color_Control extends WP_Customize_Control {
...
Business_Power_Customizer::add_custom_control( array(
    'type'     => 'color-picker',
    'class'    => 'Business_Power_Customizer_Color_Control',
    'sanitize' => array( 'Business_Power_Customizer', 'sanitize_rgba' ),
));