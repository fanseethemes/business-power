...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Business_Power_Customizer_Icon_Select_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_register_style( 'font-awesome', 
				Business_Power_Helper::get_theme_uri( 'assets/css/vendor/font-awesome/css/font-awesome.css' ), 
				array(), '4.7.0' 
			);
...
Business_Power_Customizer::add_custom_control( array(
    'type'     => 'icon',
    'class'    => 'Business_Power_Customizer_Icon_Select_Control',
    'sanitize' =>  array( 'Business_Power_Customizer', 'sanitize_choice' )
));