 ...
 * @since 1.0.0
 *
 * @package BusinessPower_ WordPress theme
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Business_Power_Page_Repeater extends WP_Customize_Control {
...
Business_Power_Customizer::add_custom_control( array(
    'type'     => 'page-repeater',
    'class'    => 'Business_Power_Page_Repeater',
    'sanitize' =>  array( 'Business_Power_Page_Repeater', 'sanitize' )
));

function business_power_page_repeater_control( $args, $section, $field ){
...
add_filter( 'business_power_customizer_get_control_arg', 'business_power_page_repeater_control', 10, 3 );

function business_power_page_repeater_get( $value, $id, $instance ){
...
add_filter( 'business_power_customizer_get', 'business_power_page_repeater_get', 10, 3 );