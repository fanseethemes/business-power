...
* @since 1.0
*
* @package Business Power WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Business_Power_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( 'business-power-customize-js', 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'business-power' )
            ));
        }
...
Business_Power_Customizer::add_custom_control( array(
    'type'     => 'reset',
    'class'    => 'Business_Power_Customizer_Reset',
    'sanitize' => false,
