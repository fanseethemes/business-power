<?php
/**
 * Customizer Control: business-power-toggle.
 *
 * @since 1.0
 *
 ...
 * @access public
 */
class business_power_Toggle_Control extends WP_Customize_Control {
...
Business_Power_Customizer::add_custom_control( array(
    'type'     => 'toggle',
    'class'    => 'business_power_Toggle_Control',
    'sanitize' => array( 'Business_Power_Customizer', 'sanitize_checkbox' )
));