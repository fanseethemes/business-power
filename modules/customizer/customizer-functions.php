 ...
 */
function business_power_customizer_files( $files ){
...
add_filter( 'business_power_modules_customizer', 'business_power_customizer_files' );
 ...
 * @package Business Power WordPress Theme
 */
function business_power_custom_controls_script(){
	...
	wp_enqueue_script( 'business-power-customizer-js', $script, $deps, '1.1', true );

	wp_enqueue_style( 'business-power-customizer-css', $style );

	wp_localize_script( 'business-power-customizer-js', 'powerBusinessColorPalette',
		array( 
			'colorPalettes' => array(
				'#000000',
				'#ffffff',
...
add_action( 'customize_controls_enqueue_scripts', 'business_power_custom_controls_script', 99	);
 ...
 * @package Business Power WordPress Theme
 */
function business_power_customize_register( $wp_customize ){
	$color_section = 'business-power-color-section';
	...
	$wp_customize->get_section( 'header_image' )->title = esc_html__( 'Inner Banner', 'business-power' );
	$wp_customize->get_section( 'header_image' )->panel = 'business-power-panel';
}
add_action( 'customize_register', 'business_power_customize_register' );
 ...
 * @package Business Power WordPress Theme
 */
function business_power_customizer_supports(){
	# Customize Selective Refresh Widgets.
	add_theme_support( 'customize-selective-refresh-widgets' );
}
add_action( 'after_setup_theme', 'business_power_customizer_supports' );