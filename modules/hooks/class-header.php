 ...
 */
if( !class_exists( 'Business_Power_Header' ) ){
	class Business_Power_Header extends Business_Power_Helper{
		...
		*/
		...
		public static function add_search_icon(){ ?>	
			<div class="business-power-header-icons">
				<a href="#" class="business-power-search-icon business-power-toggle-search">
		...
		public static function before_header(){
			?>
			<header id="masthead" <?php echo self::schema( 'header' ); ?> class="business-power-site-header" >
			<?php
		}
		...
		public static function skip_content(){
			...
			<a class="skip-link screen-reader-text" href="#content">
				<?php esc_html_e( 'Skip to content', 'business-power' ); ?>
			</a>
			<?php
		}
		...
		public static function preloader(){
		 	if( apply_filters( 'business_power_show_preloader', true ) ){ ?>
				<div id="loader-wrapper" class="business-power-loader-wrapper">
					<svg id="loaded" class="business-power-loader"><circle cx="70" cy="70" r="30" fill="#ddd" style=""></circle></svg>
				</div>
			<?php }
		}
	}

	new Business_Power_Header();
}