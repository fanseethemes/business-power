<section class="business-power-news-section">
	...
	<div class="container">
		<?php business_power_frontpage_title( 'blog' ); ?>
			<?php
				$query = new WP_Query(array(
					'posts_per_page' => business_power_get( 'blog-posts-per-page' ),
					'ignore_sticky_post' => true
				));
				if( $query->have_posts() ){
					$cls = "business-power-blog-col-" . business_power_get( 'blog-col' );
					?>
					...
					<?php
						while( $query->have_posts() ){
							$query->the_post();
							?>
							<div class="business-power-blog-col-inner ">
								<div class="business-power-news-box">
									<a href="<?php the_permalink(); ?>" class="business-power-news-img">
									...
									<div class="business-power-news-content">
										<h3> 
										...
										<div class="business-power-news-box-meta">
											<h4><?php esc_html_e( 'Categories', 'business-power' ); ?></h4>
											<?php the_category(); ?>
										</div>
									</div>
									<div class="business-power-news-date">
										<?php 
											$date = get_the_date( 'M j Y' ); 
											$date = explode( ' ', $date );
										?>
										<a href="<?php echo esc_url( Business_Power_Helper::get_day_link() ); ?>">
		...
		<div class="business-power-news-more-btn">
			<a href="<?php echo esc_url( business_power_get_blog_page_url() ); ?>" class="business-power-btn-primary"> 
				<span> <?php esc_html_e( 'View All News', 'business-power' ); ?> <i class="fa fa-long-arrow-right"></i> </span> 
			</a>	
		</div>
